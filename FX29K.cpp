...
*/
uint8_t FX29K::write(TwoWire *i2cPtr, uint8_t i2cAddr, uint8_t *arr, uint8_t byteCount)
{
...
*/
uint8_t FX29K::read(TwoWire *i2cPtr, uint8_t i2cAddr, uint8_t *arr, uint8_t byteCount)
{
